...
const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$r);
const __iconNode$q = [
...
const FolderLock = createLucideIcon("folder-lock", __iconNode$h);
const __iconNode$g = [
...
const SendHorizontal = createLucideIcon("send-horizontal", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
