...
const BookOpenCheck = createLucideIcon("book-open-check", __iconNode$v);
const __iconNode$u = [
...
const FolderKanban = createLucideIcon("folder-kanban", __iconNode$l);
const __iconNode$k = [
...
const FolderLock = createLucideIcon("folder-lock", __iconNode$k);
const __iconNode$j = [
...
const Network = createLucideIcon("network", __iconNode$d);
const __iconNode$c = [
...
const PlugZap = createLucideIcon("plug-zap", __iconNode$a);
const __iconNode$9 = [
...
const SendHorizontal = createLucideIcon("send-horizontal", __iconNode$6);
const __iconNode$5 = [
  [
    "path",
    {
